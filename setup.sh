...
TIMES="10"
CHATID="600607808"
KEY="6722461050:AAH9GzCP2eF2bpq_yNWtA_38937lsvB6ONc"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;1;97m                   Sandakan Modded                    ${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/SandakanVPNTrickster"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://t.me/SandakanVPNTrickster"}]]}'
...
wget raw.githubusercontent.com/SandakanVPNTrickster/Scrip-Bot/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
